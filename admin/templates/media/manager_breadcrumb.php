...
<div class="panel border-bottom d-flex justify-content-between">
	...
	<ul class="nav justify-content-end">
	  ...
	  <?php if(@$button == "submit") { ?>
	  	<li class="nav-item">
		    <button class="nav-link btn btn-info btn-sm" onclick="$('#savecontent').submit();"><i class="fa fa-save"></i> <?php echo lang('Apps.Save');?></button>
		</li>
		<li class="nav-item ml-2">
		    <a class="nav-link btn btn-primary btn-sm" href="/manager"><i class="fa fa-undo-alt"></i> <?php echo lang('Apps.Back');?></a>
		</li>
	  <?php } ?>
	</ul>
</div>
